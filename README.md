...
Buka http://localhost:8080. Produksi memakai Postgres (`DATABASE_URL`); pratinjau lokal memakai PGLite.

## GitHub

Repositori ini siap di-push. Buat repo kosong di GitHub, lalu:

```bash
git init
git add .
git commit -m "Pajak21: perhitungan PPh Pasal 21 TER 2026"
git remote add origin git@github.com:<akun>/pajak21.git
