          ...
          <tbody>
            {paged.rows.map(({ emp, annual, desember }) => (
              <tr key={emp.id}>
                ...
                <td className="px-3 py-2 tabular-nums">{formatRp(annual.bruto, false)}</td>
                <td className="px-3 py-2 tabular-nums">{formatRp(annual.biayaJabatan, false)}</td>
                <td className="px-3 py-2 tabular-nums">{formatRp(annual.netoSetahun, false)}</td>
                <td className="px-3 py-2 tabular-nums">{formatRp(annual.pkp, false)}</td>
                <td className="px-3 py-2 tabular-nums font-semibold">{formatRp(annual.pphTerutang, false)}</td>
                <td className="px-3 py-2 tabular-nums">{formatRp(annual.pphDipotongSebelumnya, false)}</td>
